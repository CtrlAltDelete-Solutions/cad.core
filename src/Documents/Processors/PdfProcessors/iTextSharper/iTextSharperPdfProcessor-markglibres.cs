...
namespace CAD.Documents
{
    ...
    {
        public static void ConvertFromHtml(string htmlFile, string pdfFile, string imageRootPath, string cssFile)
        {
            using(FileStream pdfStream = new FileStream(pdfFile, FileMode.OpenOrCreate))
            {
                ...
                htmlContext.SetImageProvider(new ImageProvider(imageRootPath));
